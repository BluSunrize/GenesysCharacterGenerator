...
export class Archetype {
    ...
    constructor(name: string, characteristics: number[], wound_threshold: number, strain_threshold: number, experience: number, free_careerskills: number, skills: SkillSelection[], abilities: Ability[]) {
        this.name = name;
